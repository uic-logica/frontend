> **Archived.** This was the first art, color and interaction reference, merged in #25.
> The current direction uses a different palette and different fonts (see
> [../design-direction.md](../design-direction.md) and
> [../style-guide.md](../style-guide.md)), so don't take tokens or fonts from here.
> Still useful: the per-page references in section 2 and the per-page motion ideas in
> section 6.2, for pages other than the landing page. The accessibility bar in section
> 7 now lives in the style guide.
