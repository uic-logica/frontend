  ...
  return (
    <header className="border-b border-ink bg-paper">
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-12 lg:py-20">
        <FourDots />
        <p className="type-label mt-4 text-ink-muted">{eyebrow}</p>
        <h1 className="type-h1 mt-3 max-w-3xl text-balance text-ink">{title}</h1>
        {description && (
          <p className="mt-4 max-w-measure text-body-lg text-ink-muted">{description}</p>
        )}
      </div>
    </header>
  );
